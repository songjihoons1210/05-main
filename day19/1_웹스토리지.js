/*
    [ 웹스토리지 ]
        ...
        2. 사용법
            ...
            * 속성명/key는 무조건 문자만 가능.
            * value는 객체와배열 타입 저장 불가능. 문자열,숫자,불리언 가능
        
    [ JSON ] : 자바스크립트 객체 문법의 형식 , JavaScript Object Notaion
        * 자바객체를 문자타입 이지만 객체형식/모양 으로 표현한것
        - 3 : 숫자타입 ,숫ㅈ ㅏ모양 vs "3" : 문자열타입 , 숫자모양
        - { age : 40 } : 객체타입 , 객체모양    vs "{age:40}" 문자열타입 , 객체모양
        - 왜?? 인터넷상의 데이터통신하는 http 는 객체지향이 아니다. 문자열과 바이트 전송 가능.
...
// [4] 웹스토리지에 자료 삭제
sessionStorage.removeItem( 'name' ); // 유재석 삭제
console.group(sessionStorage); // 유재석이 없어짐.
...
console.log( localStorage.getItem( 'm2' ) ); // [o] , 객체타입
        // console.log( (3+2)*3 )
        // vs
        // let r =3+2
        // let r2 = r * 3
