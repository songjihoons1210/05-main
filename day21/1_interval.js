...
function 타이머시작(){
    ...
    timerId = setInterval( 시간증가 ,1000 ); //(1000말리초)1초마다 '시간증가' 함수
}
// (3)
function 타이머중지(){
